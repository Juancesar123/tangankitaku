                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                  <a href="article/article_1.html" target="_blank"><img src="http://placehold.it/300x200/"  alt="Slide11"></a>
                                  <div class="caption">
                                    <h3>Product label</h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                  <a href="#" target="_blank"><img src="http://placehold.it/300x200/"  alt="Slide12"></a>
                                  <div class="caption">
                                    <h3>Product label</h3>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</p>
                    ...
                    <div class="item">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                  <a href="#" target="_blank"><img src="http://placehold.it/300x200/"  alt="Slide21"></a>
                                  <div class="caption">
                                    <h3>Product label</h3>
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor</p>
